...
function ThreeView({ onHeading, resetRef, rotateRef }) {
  ...
  useEffect(() => {
    ...
    const renderRaw = (raw) => {
      ...
      centroid = new THREE.Mesh(new THREE.SphereGeometry(.1, 20, 20), centroidMaterial); centroid.position.set(origin[0] || 0, origin[1] || 0, origin[2] || 0); scene.add(centroid);
    };
